...
- Fødselsstatus bruker Volven 8522 som kodet verdi og leveringstid som `effectiveDateTime`. Positiv `fosterId` korreleres med samme fosterressurs som konsultasjonsfunn.
